...
In August 2017, my first project for Streamlabs involved animating 16 existing icons for their website. We wanted to experiment with [Bodymovin](https://slykuiper.com/bodymovin/) for this project, so I delivered the 16 animated icons, each with a daymode and nightmode variant, as .json as well as .webm as a failsafe. aaaaaa
    ...
    <div class="postgrid">
        <div class="columns-wrapper">
            <div class="columns">
                ...
                <a href="{{ item.var2 }}" class="spacer">
                    <div class="postcolumn" style="background-image: url({{ item.var3 }})">
                        <div class="postcolumn__inner"><p> {{ item.var1 }} </p></div>
                    </div>
                </a>
                {% endfor %}
            </div>
