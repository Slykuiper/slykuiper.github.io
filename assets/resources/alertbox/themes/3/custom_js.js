...
function runTimeline() {
    ...
    timeline
        .fromTo('#alert-text-inner', { x: '-20', opacity: '0' }, { x: '0', opacity: '1', ease: "elastic.out(1, 1)" })
        .fromTo('#alert-event', { opacity: '0', y: '20'}, { opacity: '1', y: '0', ease: "elastic.out(1, 1)" }, '<0.5')
        .fromTo('#alert-message', { opacity: '0', x: '20'}, { opacity: '1', x: '0', ease: "elastic.out(1, 1)" }, '<0.25')
